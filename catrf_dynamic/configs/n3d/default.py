...
codec = dict(
    ...
    use_amp = None, 
    quality=None,  # for JPEG
    codec_refresh_k=None,
    refresh_trigger_eps=None,
    i_frame_weight_path='./checkpoints/cvpr2025_image.pth.tar',
    p_frame_weight_path='./checkpoints/cvpr2025_video.pth.tar',
)
