_base_ = '../default.py'
expname = 'flame_steak_image_dcvc_qp12_scratch'
ckptname = None
...
fine_train = dict(
    ...
    tv_after=-1,                   # count total variation loss from tv_from step
    tv_before=1000000,                  # count total variation before the given number of iterations
    tv_dense_before=1000000,            # count total variation densely before the given number of iterations
